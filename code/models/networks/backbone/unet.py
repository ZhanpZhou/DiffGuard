...
class Unet(nn.Module):
    ...
    def forward(self, image: torch.Tensor) -> torch.Tensor:
        ...
        for i, layer in enumerate(self.down_sample_layers):
            ...
            features.append((f'layer{i+1}', output))
...
def unet(in_channel=1, out_channel=1, chans=64, **kwargs):
    return Unet(in_channels=in_channel, out_channels=out_channel, chans=chans, **kwargs), chans * 16
