...
basic_schedulers = ['linear','step','plateau','cosine','cosineWR']
...
def get_scheduler(optimizer, opt):
    ...
    if opt.warmup:
        scheduler = GradualWarmupScheduler(optimizer, 1.0, opt.warm_epoch, scheduler)
